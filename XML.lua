...
<Button id="pokemon_toggle_White" onClick="toggleCategoryPanel" rectAlignment="LowerLeft" offsetXY="275 5" width="130" height="50" fontSize="18" fontStyle="Bold" color="#2a1a0a" textColor="#c8a882" highlightedColor="#3a2a1a" outline="#5a4030" visibility="White">Pokemon</Button>
...
<Button id="pokemon_toggle_Red" onClick="toggleCategoryPanel" rectAlignment="LowerLeft" offsetXY="275 5" width="130" height="50" fontSize="18" fontStyle="Bold" color="#2a1a0a" textColor="#c8a882" highlightedColor="#3a2a1a" outline="#5a4030" visibility="Red">Pokemon</Button>
...
<Button id="pokemon_toggle_Blue" onClick="toggleCategoryPanel" rectAlignment="LowerLeft" offsetXY="275 5" width="130" height="50" fontSize="18" fontStyle="Bold" color="#2a1a0a" textColor="#c8a882" highlightedColor="#3a2a1a" outline="#5a4030" visibility="Blue">Pokemon</Button>
...
<Button id="pokemon_toggle_Green" onClick="toggleCategoryPanel" rectAlignment="LowerLeft" offsetXY="275 5" width="130" height="50" fontSize="18" fontStyle="Bold" color="#2a1a0a" textColor="#c8a882" highlightedColor="#3a2a1a" outline="#5a4030" visibility="Green">Pokemon</Button>
...
<!-- WHITE -->
<Panel id="pokedex_panel_White" active="false" rectAlignment="MiddleCenter" offsetXY="0 0" width="3000" height="1300" image="dexPanel" color="#FFFFFF" padding="0 0 0 0" interactable="false" visibility="White" />
...
<!-- RED -->
<Panel id="pokedex_panel_Red" active="false" rectAlignment="MiddleCenter" offsetXY="0 0" width="3000" height="1300" image="dexPanel" color="#FFFFFF" padding="0 0 0 0" interactable="false" visibility="Red" />
...
<!-- BLUE -->
<Panel id="pokedex_panel_Blue" active="false" rectAlignment="MiddleCenter" offsetXY="0 0" width="3000" height="1300" image="dexPanel" color="#FFFFFF" padding="0 0 0 0" interactable="false" visibility="Blue" />
...
<!-- GREEN -->
<Panel id="pokedex_panel_Green" active="false" rectAlignment="MiddleCenter" offsetXY="0 0" width="3000" height="1300" image="dexPanel" color="#FFFFFF" padding="0 0 0 0" interactable="false" visibility="Green" />
